# Comprobador Automático CORE19-05_quiz_socket
...
$ git clone https://github.com/practicas-ging/CORE19-05_quiz_socket
$
$ cd CORE19-05_quiz_socket  ## Entrar en el directorio de trabajo del programa de test
$
...
$             ## El directorio de trabajo contiene ahora el fichero: CORE19-05_quiz_socket.zip
```

El fichero `CORE19-05_quiz_socket.zip` contiene los ficheros de la practica comprimidos y puede subirse a la plataforma para su evaluación.
